...
# Solicita ao usuário para inserir o endereço IP ou nome de domínio
echo "Por favor, insira o endereço IP ou nome de domínio para o servidor Kanboard:"
read server_ip

# Checa se uma entrada foi fornecida
if [ -z "$server_ip" ]; then
    echo "Nenhum endereço IP ou nome de domínio fornecido. Saindo..."
    exit 1
fi
